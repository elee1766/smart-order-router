...
export declare const USDC_MC_MOONBEAM: Token;
...
export declare const USDT_ZKSYNC: Token;
export declare const WBTC_ZKSYNC: Token;
export declare const WETH_ZKSYNC: Token;
export declare const BOBA: Token;
export declare const USDC_BOBA: Token;
